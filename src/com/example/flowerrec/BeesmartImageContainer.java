...
public class BeesmartImageContainer {
	...
	BeesmartImageContainer(BeesmartImageContainer InitCont){

		this.Date = InitCont.Date;
		this.Attr = "";
	}

	BeesmartImageContainer(){
	...
	BeesmartImageContainer(String InitString){
