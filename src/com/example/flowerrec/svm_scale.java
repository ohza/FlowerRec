...
class svm_scale
{
	...
	public static void runA(String argv[]) throws IOException
	{
		svm_scale s = new svm_scale();
		outFile = new PrintWriter(new FileWriter(Environment.getExternalStorageDirectory().getPath()+"/FlowerRec/testdatascale.txt"));
		outFile.print(0 + " ");
		s.run(argv);
		outFile.close();
	}
